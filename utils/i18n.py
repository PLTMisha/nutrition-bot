...
📅 <b>Реєстрація:</b> {registration_date}"""
            ...
            "search_instruction": {
                ...
                "ru": "🔍 <b>Поиск продуктов</b>\n\nВыберите категорию или найдите по названию:",
                "uk": "🔍 <b>Пошук продуктів</b>\n\nОберіть категорію або знайдіть за назвою:"
            },
            "search_by_name_instruction": {
                "en": "🔍 <b>Search by Name</b>\n\nType product name and quantity:\n\nExamples:\n• apple 150g\n• bread 50g\n• milk 200ml",
                "ru": "🔍 <b>Поиск по названию</b>\n\nНапишите название продукта и количество:\n\nПримеры:\n• яблоко 150г\n• хлеб 50г\n• молоко 200мл",
                "uk": "🔍 <b>Пошук за назвою</b>\n\nНапишіть назву продукту та кількість:\n\nПриклади:\n• яблуко 150г\n• хліб 50г\n• молоко 200мл"
            },
            "searching_product": {
                "en": "🔍 Searching for '{product}'...",
                "ru": "🔍 Ищу '{product}'...",
                "uk": "🔍 Шукаю '{product}'..."
            },
            # Barcode scanning
            "barcode_instruction": {
                "en": "📱 <b>Barcode Scanning</b>\n\nSend a clear photo of the product barcode.\n\nTips:\n• Good lighting\n• Hold camera steady\n• Barcode should be clearly visible",
                "ru": "📱 <b>Сканирование штрих-кода</b>\n\nОтправьте четкое фото штрих-кода товара.\n\nСоветы:\n• Хорошее освещение\n• Держите камеру ровно\n• Штрих-код должен быть четко виден",
                "uk": "📱 <b>Сканування штрих-коду</b>\n\nНадішліть чітке фото штрих-коду товару.\n\nПоради:\n• Гарне освітлення\n• Тримайте камеру рівно\n• Штрих-код має бути чітко видно"
            },
            "barcode_instructions": {
                "en": "📱 <b>How to Scan Barcode</b>\n\n1. Find the barcode on product packaging\n2. Take a clear photo\n3. Make sure barcode is fully visible\n4. Send the photo to bot\n\n💡 <i>The bot will automatically detect and process the barcode</i>",
                "ru": "📱 <b>Как сканировать штрих-код</b>\n\n1. Найдите штрих-код на упаковке товара\n2. Сделайте четкое фото\n3. Убедитесь, что штрих-код полностью виден\n4. Отправьте фото боту\n\n💡 <i>Бот автоматически распознает и обработает штрих-код</i>",
                "uk": "📱 <b>Як сканувати штрих-код</b>\n\n1. Знайдіть штрих-код на упаковці товару\n2. Зробіть чітке фото\n3. Переконайтеся, що штрих-код повністю видно\n4. Надішліть фото боту\n\n💡 <i>Бот автоматично розпізнає та обробить штрих-код</i>"
            },
            # Photo analysis
            "photo_instruction": {
                "en": "📷 <b>Food Photo Analysis</b>\n\nTake a photo of your meal with a reference object for size estimation.\n\nClick 'Upload Photo' when ready!",
                "ru": "📷 <b>Анализ блюд по фото</b>\n\nСфотографируйте блюдо с эталонным предметом для оценки размера.\n\nНажмите 'Загрузить фото' когда будете готовы!",
                "uk": "📷 <b>Аналіз страв за фото</b>\n\nСфотографуйте страву з еталонним предметом для оцінки розміру.\n\nНатисніть 'Завантажити фото' коли будете готові!"
            },
            "photo_instructions": {
                "en": "📷 <b>Photo Analysis Instructions</b>\n\n1. Place a reference object next to your food\n2. Take a clear photo from above\n3. Make sure both food and reference object are visible\n4. Send the photo to bot\n\n<b>Reference objects:</b>\n• 1€ coin (23.25mm)\n• 2€ coin (25.75mm)\n• Credit card (85.6×53.98mm)\n• Tablespoon (20cm)\n• Standard plate (24cm)",
                "ru": "📷 <b>Инструкция по анализу фото</b>\n\n1. Поместите эталонный предмет рядом с едой\n2. Сделайте четкое фото сверху\n3. Убедитесь, что видны и еда, и эталонный предмет\n4. Отправьте фото боту\n\n<b>Эталонные предметы:</b>\n• Монета 1€ (23.25мм)\n• Монета 2€ (25.75мм)\n• Кредитная карта (85.6×53.98мм)\n• Столовая ложка (20см)\n• Стандартная тарелка (24см)",
                "uk": "📷 <b>Інструкція з аналізу фото</b>\n\n1. Помістіть еталонний предмет поруч з їжею\n2. Зробіть чітке фото зверху\n3. Переконайтеся, що видно і їжу, і еталонний предмет\n4. Надішліть фото боту\n\n<b>Еталонні предмети:</b>\n• Монета 1€ (23.25мм)\n• Монета 2€ (25.75мм)\n• Кредитна картка (85.6×53.98мм)\n• Столова ложка (20см)\n• Стандартна тарілка (24см)"
            },
            "reference_objects": {
                "en": "📏 <b>Reference Objects</b>\n\n<b>Coins:</b>\n• 1€ coin - 23.25mm diameter\n• 2€ coin - 25.75mm diameter\n\n<b>Cutlery:</b>\n• Tablespoon - 20cm length\n• Teaspoon - 13cm length\n• Fork - 20cm length\n• Knife - 22cm length\n\n<b>Dishes:</b>\n• Standard plate - 24cm diameter\n• Saucer - 15cm diameter\n• Cup/Mug - 9cm height, 8cm diameter\n• Glass - 10.5cm height, 7.3cm diameter\n\n<b>Other:</b>\n• Credit card - 85.6×53.98mm\n• Matchbox - 50×35mm\n• BIC lighter - 80.5×25.5mm",
                "ru": "📏 <b>Эталонные объекты</b>\n\n<b>Монеты:</b>\n• Монета 1€ - диаметр 23.25мм\n• Монета 2€ - диаметр 25.75мм\n\n<b>Столовые приборы:</b>\n• Столовая ложка - длина 20см\n• Чайная ложка - длина 13см\n• Вилка - длина 20см\n• Нож - длина 22см\n\n<b>Посуда:</b>\n• Стандартная тарелка - диаметр 24см\n• Блюдце - диаметр 15см\n• Чашка/кружка - высота 9см, диаметр 8см\n• Стакан - высота 10.5см, диаметр 7.3см\n\n<b>Другое:</b>\n• Кредитная карта - 85.6×53.98мм\n• Спичечный коробок - 50×35мм\n• Зажигалка BIC - 80.5×25.5мм",
                "uk": "📏 <b>Еталонні об'єкти</b>\n\n<b>Монети:</b>\n• Монета 1€ - діаметр 23.25мм\n• Монета 2€ - діаметр 25.75мм\n\n<b>Столові прибори:</b>\n• Столова ложка - довжина 20см\n• Чайна ложка - довжина 13см\n• Виделка - довжина 20см\n• Ніж - довжина 22см\n\n<b>Посуд:</b>\n• Стандартна тарілка - діаметр 24см\n• Блюдце - діаметр 15см\n• Чашка/кружка - висота 9см, діаметр 8см\n• Склянка - висота 10.5см, діаметр 7.3см\n\n<b>Інше:</b>\n• Кредитна картка - 85.6×53.98мм\n• Сірниковий коробок - 50×35мм\n• Запальничка BIC - 80.5×25.5мм"
            },
            "photo_tips": {
                "en": "💡 <b>Photo Tips</b>\n\n<b>For best results:</b>\n• Use good lighting (natural light preferred)\n• Take photo from directly above\n• Keep camera steady\n• Include reference object in frame\n• Make sure food portions are clearly visible\n• Avoid shadows on food\n\n<b>What the bot can recognize:</b>\n• Most common dishes and ingredients\n• Portion sizes using reference objects\n• Multiple food items on one plate\n\n<b>Limitations:</b>\n• Complex mixed dishes may be less accurate\n• Very small portions might be hard to detect\n• Dark or blurry photos reduce accuracy",
                "ru": "💡 <b>Советы по фото</b>\n\n<b>Для лучших результатов:</b>\n• Используйте хорошее освещение (предпочтительно естественное)\n• Фотографируйте строго сверху\n• Держите камеру неподвижно\n• Включите эталонный предмет в кадр\n• Убедитесь, что порции еды четко видны\n• Избегайте теней на еде\n\n<b>Что бот может распознать:</b>\n• Большинство обычных блюд и ингредиентов\n• Размеры порций с помощью эталонных предметов\n• Несколько продуктов на одной тарелке\n\n<b>Ограничения:</b>\n• Сложные смешанные блюда могут быть менее точными\n• Очень маленькие порции трудно определить\n• Темные или размытые фото снижают точность",
                "uk": "💡 <b>Поради щодо фото</b>\n\n<b>Для кращих результатів:</b>\n• Використовуйте гарне освітлення (бажано природне)\n• Фотографуйте строго зверху\n• Тримайте камеру нерухомо\n• Включіть еталонний предмет у кадр\n• Переконайтеся, що порції їжі чітко видно\n• Уникайте тіней на їжі\n\n<b>Що бот може розпізнати:</b>\n• Більшість звичайних страв та інгредієнтів\n• Розміри порцій за допомогою еталонних предметів\n• Кілька продуктів на одній тарілці\n\n<b>Обмеження:</b>\n• Складні змішані страви можуть бути менш точними\n• Дуже маленькі порції важко визначити\n• Темні або розмиті фото знижують точність"
            },
            # Statistics and nutrition callbacks
            "view_stats": {
                "en": "📊 <b>Statistics</b>\n\nChoose time period:",
                "ru": "📊 <b>Статистика</b>\n\nВыберите период:",
                "uk": "📊 <b>Статистика</b>\n\nОберіть період:"
